...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="la date d'arrivée doit etre ultérieurement d'aujoud'hui")
     */
    private $startDate;

    /**
     * @ORM\Column(type="datetime")
     * @Assert\Date(message="la date de départ doit étre au bon format ")
    ...
    public function isBookablesDates(){
        //1) connaitre les date qui sont impossible pour l'annonce 
        ...
        //2) il faut comparer les dates choisis avec les dates impossibles 
            ...
            // Tableau des chaines de caractèers de mes journées
        ...
        /**
         * Permet de récupérer un tableau des journées qui coorespondent à ma réservation 
         *
